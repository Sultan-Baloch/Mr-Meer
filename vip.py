...
\033[1;96m ╚═════╝░░╚═════╝░╚══════╝░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚══╝ 
\033[1;94m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗  ℳℰℰℛ 𝒮𝒰ℒ𝒯𝒜𝒩                           ║    
\033[1;98m    ║✯ 𝕱𝖆𝖈𝖊𝖇𝖔𝖔𝖐  https://m.facebook.com/meersultan.khoso  ║  
\033[1;96m    ║✯ 𝓥ℯ𝓇𝓈𝒾ℴ𝓃 0.2                                      ║
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════════════¤═══¤═══¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE MR Sultan~
\033[1;97m************************************************
\033[1;92m                    _-.                       .-_
\033[1;92m                 _..-'(                       )`-.._
\033[1;92m              ./'. '||\\.       (\_/)       .//||` .`\.
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:SULTAN-AHMED
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('xdg-open https://wa.me/923476508876?text=Aslam o alaikum Meer Sultan. Please give me . user and pass for using this Vip tools')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mMeer Sultan\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mMeer Sultan\033[1;97m•◈•══════•◈•"
		try:
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mMeer Sultan\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By Meer Sultan--•◈•---»" #Dev: Sultan
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 vip.py)↩\033[1;97m....'
...
\033[1;92m_______¶¶¶_________¶______¶_________¶¶¶______
        ...
        Open Checkpoint Id After 7 Days
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....Meer Sultan Khoso....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m Sultan Ahmed"""
